...
export default function ContactPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 md:px-8 py-12 md:py-20">
      <div className="glass-journal rounded-3xl p-8 sm:p-12 md:p-14 border border-gold/35 text-center relative overflow-hidden shadow-card">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <a
            ...
            className="btn-secondary text-xs sm:text-sm gap-2.5 min-h-[44px]"
          >
            <svg
